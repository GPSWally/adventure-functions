...
function newAdvent() {
	...
	*/
	var chosenMonster = monsters[arrIndex(monsters)];
	var chosenWeapon = weapons[arrIndex(weapons)];
	var chosenAction = actions[arrIndex(actions)];
	var chosenRoom = rooms[arrIndex(rooms)];
